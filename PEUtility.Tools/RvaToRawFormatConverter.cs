...
namespace PEUtility.Tools
{
    ...
    {
        public static UInt32? DefineSection(UInt32 rva, SectionHeader[] sectionHeaders, UInt32 sectionAlignment)
        {
        ...
        public static UInt32 RvaToOffset(UInt32 rva, SectionHeader[] sectionHeaders, UInt32 sectionAlignment)
        {
